                    ...
                    >
                        <ul data-testid='modalContent'>
                            <li className='flex gap-3 justify-between'>
                                ...
                                قیمت ها برای کسانی که می‌خواهند قیمت ثبت کنند تا
                                آخر تازیخ ثبت قیمت پنهان است و در آخر برنده و
                                مبلغ آن مشخص می‌شود.
                            </li>
                            <li className='flex gap-3 justify-between'>
                                <span className='font-semibold text-sky-400/100 text-xl'>
                                ...
                                قیمت ها برای همه قابل نمایش است و در هر لحظه
                    ...
                    >
                        <ul data-testid='modalContent2'>
                            <li className=' gap-3 justify-between'>
                                ...
                                در مناقصه ها در حالت آفلاین میبایست از این قیمت
                                پایین تر باشد.
                            </li>
                            <li className=' gap-3 justify-between'>
                                <span className='flex font-semibold text-sky-400/100 text-xl'>
                                ...
                                در مزایده ها در حالت آفلاین میبایست از این قیمت
                                بالاتر باشد.
                            </li>
                        </ul>
                    </Typography>
