...
import { MSG_LIST_1_3 } from "utils/constant/chatData";
import { useNavigate } from "react-router-dom";
import { FULL_LAYOUT_CHAT } from "utils/constant/routes";
...
export const Messages = () => {
    ...
    const [socketUrl, setSocketUrl] = useState(
        `ws://188.121.113.13:8888/chat/${userName}/${localStorage.getItem(
            "access"
        )}`
    );
